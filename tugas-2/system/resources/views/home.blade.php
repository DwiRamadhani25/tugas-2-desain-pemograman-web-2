...
<body>
                    ...
                    <li class="slide">
                        <div class="item">
                            <img src="{{ url('public') }}/images/thumb1.png" width="226" height="225" alt="sliderimg" class="wow flipInX"
                                data-wow-delay=".8s">
                                <a href="{{ url('produk') }}" style="text-decoration: none">
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            ...
            <div class="staff">
                <ul>
                    <li><img src="{{ url('public') }}/images/char3.png" width="163" height="163" class="myimage wow fadeIn" title="mido"
                            alt="1">


                    </li>
                    <li><img src="{{ url('public') }}/images/char4.png" width="163" height="163" class="myimage2 wow fadeIn"
                            data-wow-delay="0.8s" alt="1"></li>
                    <li><img src="{{ url('public') }}/images/char5.png" width="163" height="163" class="myimage3 wow fadeIn"
                            data-wow-delay="0.8s" alt="1"></li>
                    <li><img src="{{ url('public') }}/images/char6.png" width="163" height="163" class="myimage4 wow fadeIn" alt="1"
                            data-wow-delay="0.8s"></li>
                    <li><img src="{{ url('public') }}/images/char1.png" width="163" height="163" class="myimage5 wow fadeIn" alt="1"
                            data-wow-delay="0.8s"></li>
                    <li><img src="{{ url('public') }}/images/char2.png" width="163" height="163" class="myimage6 wow fadeIn" alt="1"
                            data-wow-delay="0.8s"></li>
                </ul>
            ...
            <img src="{{ url('public') }}/images/pop1.png" width="486" height="137" class="firstpop" alt="pop">
            <img src="{{ url('public') }}/images/popup2.png" width="487" height="137" class="secondpop" alt="pop">
            <img src="{{ url('public') }}/images/popup3.png" width="487" height="137" class="thirdpop" alt="pop">
            <img src="{{ url('public') }}/images/popup4.png" width="487" height="137" class="fourthpop" alt="pop">
            <img src="{{ url('public') }}/images/popup6.png" width="487" height="137" class="fifthpop" alt="pop">
            <img src="{{ url('public') }}/images/popup7.png" width="487" height="137" class="sixthpop" alt="pop">
